...
The Navigation bar provides global site orientation, branding, and in-page navigation. It is fixed at the top of the viewport with a frosted glass effect, allowing visitors to quickly jump between sections (Home, Projects, Contact) via smooth scrolling. It adapts to system light/dark mode and is fully keyboard-accessible.
...
- **AND** 目标 Section 顶部与 Navbar 底部对齐（通过 `scroll-padding-top` 补偿 Navbar 高度）
